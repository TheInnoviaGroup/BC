<?php
// $Id: autocomplete.php,v 1.1 2005/06/28 07:26:10 bryan Exp $
...
require_once 'example_utils.php';
...
<p>Note: the client side keypress handling logic could probably be improved in this example - <strong>in IE especially it sucks</strong>. Otherwise demonstrates how coding effort on client and server side is focused purely on application logic - the "networking" between client and server is no effort - even HTTP authentication is easily done.</p>
</body>
</html>
