...
#Dates are special. Note also, gotta have PHP 5.1.0 to have dates before 1970.
	...
	if ($date[0] < 13) {
	  ...
	  // Utimes are measured since 1/1/1970, so we have to adjust by -2208985200, (-2209046400) which is the utime of 1/1/1900.
	...
	$utime = $seconds - 2208985200;
	 ...
	 break;
      ...
      $companypeople[$dest] = preg_replace('/\'/', '&#039;', $data[$count]);
      $dothis['companypeople'] = 1;
