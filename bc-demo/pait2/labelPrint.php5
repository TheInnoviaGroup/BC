...
print "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" bgcolor=\"#FFFFFF\">
	...
	// show the form
?>	
<form method="post" action="labelPrint.php5">
<table border="0" cellspacing="0" cellpadding="5" align="center">
	...
	<tr>
		<td align="center" colspan="2"><input name="saveID" id="saveID" type="hidden" value="<?=$form->saveID;?>" />
		<input name="limitresults" id="limitresults" type="hidden" value="0" />
		<input name="labels" id="labels" type="hidden" value="TRUE" />
