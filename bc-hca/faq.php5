...
<div class="answer">Please call your SIP Plan representative at <? if($user->NewBenefitLOB2 > 0): ?>888-640-8470<? else: ?>866-951-0699<? endif; ?></div>
...
<div class="answer">
<ul type="disc">
	<li>Discounted Premium Rates because you are an affiliated-employee of HCA.</li>
...
<div class="answer">YES. Your personalized information provides premiums for both tobacco and non-tobacco use. If you are an occasional cigar smoker (less than two cigars per month) you should complete the form as a non-tobacco user. Please provide details of your cigar use after question 4.</div>
...
<div class="answer">Your payroll deductions will begin the first pay date in August 2009. Premiums are deducted one month in advance of the policy date.</div>
...
<p>
&copy;2008 Unum Group. All rights reserved. Unum is a registered trademark and marketing brand of Unum Group and its insuring subsidiaries.
</p>
