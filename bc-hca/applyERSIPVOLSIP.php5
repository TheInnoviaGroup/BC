...
include_once( 'unumSOAPERSIPVOLSIP.inc' );
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" align="center" class="mainTable">
	...
	<tr>
		<td align="center" class="apply" valign="top"><a href="javascript:doForm('form1');"><img 
src="images/button_apply.jpg" alt="" width="200" height="60" hspace="5" border="0"></a><p>When you click the button you will be transferred to the UNUM website to complete the enrollment process.
</p>
</td>
	</tr>
</table>
